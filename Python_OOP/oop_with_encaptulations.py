...
class People:
    def __init__(self, first_name, last_name , age, height):
        ...
        self.__people_age = age  # self.people_age = age
    ...
    def set_name(self, new_name):
        if self.__name_validation(new_name):
            ...
            print("You name is invalid")
        
    def __name_validation(self,checking_name):
        return re.fullmatch('[A-Za-z]{2,25}([A-Za-z]{2,25})?', checking_name)
        
    def all_info(self):
        return f"Full Name : {self.get_name()} Age: {self.__people_age} , People Height : {self.people_height}"
...
# print(people_1.__people_age)


print(people_1.all_info())

people_1.set_name("00Rahim")
